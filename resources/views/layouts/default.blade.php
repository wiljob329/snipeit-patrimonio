<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ Helper::determineLanguageDirection() }}">

<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="author" content="Wilfredo Murillo-wilmugo.it@gmail.com">
    <title>
        @section('title')
        @show
    ...
    @if ($snipeSettings && $snipeSettings->header_color != '')
        <style nonce="{{ csrf_token() }}">
            ...
            .skin-{{ $snipeSettings->skin != '' ? $snipeSettings->skin : 'blue' }} .sidebar-menu>li:hover>a,
            .skin-{{ $snipeSettings->skin != '' ? $snipeSettings->skin : 'blue' }} .sidebar-menu>li.active>a {
...
@if ($snipeSettings && $snipeSettings->allow_user_skin == 1 && Auth::check() && Auth::user()->present()->skin != '')
    ...
    <body
        class="sidebar-mini skin-{{ $snipeSettings->skin != '' ? Auth::user()->present()->skin : 'blue' }} {{ session('menu_state') != 'open' ? 'sidebar-mini sidebar-collapse' : '' }}">
    @else

        <body
            class="sidebar-mini skin-{{ $snipeSettings->skin != '' ? $snipeSettings->skin : 'blue' }} {{ session('menu_state') != 'open' ? 'sidebar-mini sidebar-collapse' : '' }}">
@endif
                    ...
                    @can('index', \App\Models\Asset::class)
                        <li aria-hidden="true"{!! Request::is('hardware*') ? ' class="active"' : '' !!}>
                            <a href="{{ url('hardware') }}"
                                ...
                                data-tooltip="true" data-placement="bottom" data-title="{{ trans('general.assets') }}">
                    ...
                    @can('view', \App\Models\License::class)
                        <li aria-hidden="true"{!! Request::is('licenses*') ? ' class="active"' : '' !!}>
                            <a href="{{ route('licenses.index') }}"
                                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=2' : '' }} tabindex="-1"
                                data-tooltip="true" data-placement="bottom" data-title="{{ trans('general.licenses') }}">
                    ...
                    @can('index', \App\Models\Accessory::class)
                        <li aria-hidden="true"{!! Request::is('accessories*') ? ' class="active"' : '' !!}>
                            <a href="{{ route('accessories.index') }}"
                                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=3' : '' }} tabindex="-1"
                                data-tooltip="true" data-placement="bottom"
                                data-title="{{ trans('general.accessories') }}">
                    ...
                    @can('index', \App\Models\Consumable::class)
                        <li aria-hidden="true"{!! Request::is('consumables*') ? ' class="active"' : '' !!}>
                            <a href="{{ url('consumables') }}"
                                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=4' : '' }} tabindex="-1"
                                data-tooltip="true" data-placement="bottom"
                                data-title="{{ trans('general.consumables') }}">
                    ...
                    @can('view', \App\Models\Component::class)
                        <li aria-hidden="true"{!! Request::is('components*') ? ' class="active"' : '' !!}>
                            <a href="{{ route('components.index') }}"
                                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=5' : '' }} tabindex="-1"
                                data-tooltip="true" data-placement="bottom" data-title="{{ trans('general.components') }}">
                    ...
                    @can('admin')
                        @if ($snipeSettings->show_alerts_in_menu == '1')
                            ...
                            <li class="dropdown tasks-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header">
                                        {{ trans('general.quantity_minimum', ['count' => count($alert_items)]) }}</li>
                                    <li>
                                                    ...
                                                    <a
                                                        ...
                                                        <div class="progress xs">
                                                            <div class="progress-bar progress-bar-yellow"
                                                                ...
                                                                <span class="sr-only">{{ $alert_items[$i]['percent'] }}%
                                                                    Complete</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                ...
                                @can('self.api')
                                    <li>
                                        <a href="{{ route('user.api') }}">
                                            <i class="fa-solid fa-user-secret fa-fw" aria-hidden="true"></i></i>
                ...
                @can('index', \App\Models\Asset::class)
                                ...
                                @foreach ($status_navs as $status_nav)
                                    <li{!! Request::is('statuslabels/' . $status_nav->id) ? ' class="active"' : '' !!}>
                                        <a href="{{ route('statuslabels.show', ['statuslabel' => $status_nav->id]) }}">
                                            ...
                                            {{ $status_nav->name }}
                                            <span class="badge badge-secondary">{{ $status_nav->asset_count }}</span></a>
                    </li>
                    @endforeach
                    @endif
                    ...
                    <li{!! Request::query('status') == 'Deployed' ? ' class="active"' : '' !!}>
                        <a href="{{ url('hardware?status=Deployed') }}">
                            ...
                            <span
                                class="badge">{{ isset($total_deployed_sidebar) ? $total_deployed_sidebar : '' }}</span>
                        </a>
                        </li>
                        <li{!! Request::query('status') == 'RTD' ? ' class="active"' : '' !!}>
                            ...
                            <li{!! Request::query('status') == 'Pending' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Pending') }}"><i
                                        class="far fa-circle text-orange fa-fw"></i>
                                    {{ trans('general.pending') }}
                                    <span
                                        class="badge">{{ isset($total_pending_sidebar) ? $total_pending_sidebar : '' }}</span>
                                </a>
                                </li>
                                <li{!! Request::query('status') == 'Undeployable' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Undeployable') }}"><i
                                            class="fas fa-times text-red fa-fw"></i>
                                        {{ trans('general.undeployable') }}
                                        <span
                                            class="badge">{{ isset($total_undeployable_sidebar) ? $total_undeployable_sidebar : '' }}</span>
                                    </a>
                                    </li>
                                    <li{!! Request::query('status') == 'byod' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=byod') }}"><i
                                                class="fas fa-times text-red fa-fw"></i>
                                            {{ trans('general.byod') }}
                                            <span
                                                class="badge">{{ isset($total_byod_sidebar) ? $total_byod_sidebar : '' }}</span>
                                        </a>
                                        </li>
                                        <li{!! Request::query('status') == 'Archived' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Archived') }}"><i
                                                    class="fas fa-times text-red fa-fw"></i>
                                                {{ trans('admin/hardware/general.archived') }}
                                                <span
                                                    class="badge">{{ isset($total_archived_sidebar) ? $total_archived_sidebar : '' }}</span>
                                            </a>
                                            </li>
                                                ...
                                                @can('audit', \App\Models\Asset::class)
                                                    <li{!! Request::is('hardware/audit/due') ? ' class="active"' : '' !!}>
                                                        <a href="{{ route('assets.audit.due') }}">
                                                            <i class="fas fa-history text-yellow fa-fw"></i>
                                                            {{ trans('general.audit_due') }}
                                                            <span
                                                                class="badge">{{ isset($total_due_and_overdue_for_audit) ? $total_due_and_overdue_for_audit : '' }}</span>
                                                        </a>
                                                        </li>
                                                    @endcan
                                                    ...
                                                    @can('checkin', \App\Models\Asset::class)
                                                        <li{!! Request::is('hardware/checkins/due') ? ' class="active"' : '' !!}>
                                                            <a href="{{ route('assets.checkins.due') }}">
                                                                ...
                                                                <span
                                                                    class="badge">{{ isset($total_due_and_overdue_for_checkin) ? $total_due_and_overdue_for_checkin : '' }}</span>
                                                            </a>
                                                            </li>
                                                        @endcan
                                ...
                                @can('view', \App\Models\User::class)
                                    <li{!! Request::is('users*') ? ' class="active"' : '' !!}>
                                        <a href="{{ route('users.index') }}"
                                            {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=6' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\AssetModel::class)
                                                        <li>
                                                            <a href="{{ route('models.index') }}"
                                                                {{ Request::is('/assetmodels') ? ' class="active"' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\Manufacturer::class)
                                                        <li>
                                                            <a href="{{ route('manufacturers.index') }}"
                                                                {{ Request::is('/manufacturers') ? ' class="active"' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\Supplier::class)
                                                        <li>
                                                            <a href="{{ route('suppliers.index') }}"
                                                                {{ Request::is('/suppliers') ? ' class="active"' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\Department::class)
                                                        <li>
                                                            <a href="{{ route('departments.index') }}"
                                                                {{ Request::is('/departments') ? ' class="active"' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\Location::class)
                                                        <li>
                                                            <a href="{{ route('locations.index') }}"
                                                                {{ Request::is('/locations') ? ' class="active"' : '' }}>
                                                    ...
                                                    @can('view', \App\Models\Depreciation::class)
                                                        <li>
                                                            <a href="{{ route('depreciations.index') }}"
                                                                {{ Request::is('/depreciations') ? ' class="active"' : '' }}>
                                                ...
                                                <ul class="treeview-menu">
                                                    <li>
                                                        <a href="{{ route('reports.activity') }}"
                                                            {{ Request::is('reports/activity') ? ' class="active"' : '' }}>
                                                            {{ trans('general.activity_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/custom') }}"
                                                            {{ Request::is('reports/custom') ? ' class="active"' : '' }}>
                                                            {{ trans('general.custom_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('reports.audit') }}"
                                                            {{ Request::is('reports.audit') ? ' class="active"' : '' }}>
                                                            {{ trans('general.audit_report') }}</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/depreciation') }}"
                                                            {{ Request::is('reports/depreciation') ? ' class="active"' : '' }}>
                                                            {{ trans('general.depreciation_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/licenses') }}"
                                                            {{ Request::is('reports/licenses') ? ' class="active"' : '' }}>
                                                            {{ trans('general.license_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/asset_maintenances') }}"
                                                            {{ Request::is('reports/asset_maintenances') ? ' class="active"' : '' }}>
                                                            {{ trans('general.asset_maintenance_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/unaccepted_assets') }}"
                                                            {{ Request::is('reports/unaccepted_assets') ? ' class="active"' : '' }}>
                                                            {{ trans('general.unaccepted_asset_report') }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('reports/accessories') }}"
                                                            {{ Request::is('reports/accessories') ? ' class="active"' : '' }}>
...
<script nonce="{{ csrf_token() }}">
    ...
    clipboard.on('success', function(e) {
        ...
        clickedElement.tooltip('hide').attr('data-original-title', '{{ trans('general.copied') }}').tooltip(
            'show');
    });
