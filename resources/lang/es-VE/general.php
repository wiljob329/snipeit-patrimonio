...
return [
    ...
    'lookup_by_tag'         => 'Buscar código del activo',
...
<p>Si desea exportar solo ciertos activos, use las siguientes opciones para afinar los resultados.</p>',
    ...
    'accessories_count'     => 'Número de accesorios',
    'consumables_count'     => 'Número de consumibles',
    ...
    'merge_information' =>  'Esto fusionará a los usuarios :count en un solo usuario. Seleccione el usuario en el que desea fusionar a los demás a continuación, y los activos asociados, licencias, etc se moverá al usuario seleccionado y los otros usuarios serán marcados como eliminados.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'La generación autoincrementable de los códigos de activos está desactivada, por lo que todas las filas deben tener la columna "Asset Tag" con información.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Nota: La generación autoincrementable de los códigos de activos está activada, por lo que se crearán activos para las filas sin información en la columna "Asset Tag". Las filas que sí tengan informacióin en la columna "Asset Tag" se actualizarán con la información proporcionada.',
    ...
    'importer' => [
        ...
        'checked_out_to_tag' => 'Asignado a: Código de activo',
