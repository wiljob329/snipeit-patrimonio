...
return [
    ...
    'auto_increment_assets'		=> 'Generar códigos de activos autoincrementables',
    'auto_increment_prefix'		=> 'Prefijo (opcional)',
    'auto_incrementing_help'    => 'Habilite primero el incremento automático de los códigos de activos antes de configurar esto',
...
'ldap_location_help'             => 'El campo Location (ubicación) de Ldap debe utilizarse si <strong>una OU no está siendo utilizada en el Base Bind DN (DN del enlace base).</strong> Deje este espacio en blanco si se utiliza una búsqueda OU.',
    ...
    'zerofill_count'        => 'Longitud de los números en los códigos de los activos, incluyendo los ceros de relleno',
    ...
    'asset_tag_title' => 'Actualizar la configuración de los códigos de activos',
